...
################################################################################
mkdir -p $INSTALLPATH/usr/share/dia/shapes/stickman3dfront/
mkdir -p $INSTALLPATH/usr/share/dia/sheets/
cp -v -f $SRCPATH/dia-shapes/shapes/stickman3dfront/*.png   $INSTALLPATH/usr/share/dia/shapes/stickman3dfront/
cp -v -f $SRCPATH/dia-shapes/shapes/stickman3dfront/*.shape $INSTALLPATH/usr/share/dia/shapes/stickman3dfront/
