...
################################################################################
mkdir -p $INSTALLPATH/shapes/stickman3dfront/
mkdir -p $INSTALLPATH/sheets/
cp -f $SRCPATH/dia-shapes/shapes/stickman3dfront/*/*.png   $INSTALLPATH/shapes/stickman3dfront/
cp -f $SRCPATH/dia-shapes/shapes/stickman3dfront/*/*.shape $INSTALLPATH/shapes/stickman3dfront/
