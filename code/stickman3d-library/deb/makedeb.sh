...
################################################################################
mkdir -p $INSTALLPATH/usr/share/dia/shapes/stickman3d/
mkdir -p $INSTALLPATH/usr/share/dia/sheets/
cp -v -f $SRCPATH/dia-shapes/shapes/stickman3d/*.png   $INSTALLPATH/usr/share/dia/shapes/stickman3d/
cp -v -f $SRCPATH/dia-shapes/shapes/stickman3d/*.shape $INSTALLPATH/usr/share/dia/shapes/stickman3d/
