...
################################################################################
mkdir -p $INSTALLPATH/shapes/footwork-notation/
mkdir -p $INSTALLPATH/sheets/
cp -f $SRCPATH/dia-shapes/shapes/footwork-notation/*.png   $INSTALLPATH/shapes/footwork-notation/
cp -f $SRCPATH/dia-shapes/shapes/footwork-notation/*.shape $INSTALLPATH/shapes/footwork-notation/
