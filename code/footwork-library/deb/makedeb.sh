...
################################################################################
mkdir -p $INSTALLPATH/usr/share/dia/shapes/footwork-notation/
mkdir -p $INSTALLPATH/usr/share/dia/sheets/
cp -v -f $SRCPATH/dia-shapes/shapes/footwork-notation/*.png   $INSTALLPATH/usr/share/dia/shapes/footwork-notation/
cp -v -f $SRCPATH/dia-shapes/shapes/footwork-notation/*.shape $INSTALLPATH/usr/share/dia/shapes/footwork-notation/
