...
\usepackage{calc} %% para evitar el error: ! Missing number, treated as zero.
...
\addbibresource{bibliography/historiapassos.bib} % BibTeX bibliography file
...
\addbibresource{bibliography/bobyexpresion.bib} % BibTeX bibliography file
\addbibresource{bibliography/bodyteoria.bib} % BibTeX bibliography file
\addbibresource{bibliography/musicalidade.bib} % BibTeX bibliography file
\addbibresource{bibliography/learning.bib} % BibTeX bibliography file
