...
\fill[colorsystemdefault!20](0cm,0cm) rectangle (\paperwidth,-\paperheight);
\node[anchor=north] at (4cm,-3.25cm){\color{colorsystemdefault!40}\fontsize{220}{100}\sffamily\bfseries\@Roman\c@part}; 
...
\setlength\fboxsep{0pt}%
\noindent\protect\colorbox{colorsystemdefault!40}{\strut\protect\parbox[c][.7cm]{\linewidth}{\Large\sffamily\protect\centering #1\quad\mbox{}}}}{#1}}%
\@endpart}
\def\@endpart{\vfil\newpage
\if@twoside
\if@openright
...
\node at (current page.north west)
{
	...
	\draw[anchor=west] (\Gm@lmargin,-9cm) node [line width=4pt,rounded corners=25pt,draw=colorsystemdefault,fill=white,fill opacity=0.5,inner sep=25pt]{\strut\makebox[\paperwidth]{}};
	\draw[anchor=west] (\Gm@lmargin+.3cm,-9.3cm) node [text width=0.7\paperwidth]{  \huge\sffamily\bfseries\color{black}\begin{flushright} \thechapter. #1 \end{flushright}\strut};
	\end{tikzpicture}
};
\end{tikzpicture}
\else
...
{\begin{tikzpicture}[remember picture,overlay]
\node[anchor=north west,inner sep=0pt] at (0,0) {\includegraphics[width=\paperwidth]{\thechapterimage}};
\draw[anchor=west] (\Gm@lmargin,-9cm) node [line width=4pt,rounded corners=15pt,draw=ocre,fill=white,fill opacity=0.5,inner sep=15pt]{\strut\makebox[22cm]{}};
...
\titleformat{\section}
  ...
  [\vskip-1.35ex\hskip-0em{\color{colorsystemdefault!60}\titlerule[4pt]}]
