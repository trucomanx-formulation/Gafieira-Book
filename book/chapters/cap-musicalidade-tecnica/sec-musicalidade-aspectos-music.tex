...
nossa dança mostrará mais \hyperref[sec:musicalidadeinfmutua]{\textbf{informação mutua}} com a música; 
ou seja mais \hyperref[sec:musicalidadeinfmutua]{\textbf{musicalidade}};
...
mas não existe uma melodia que possa ser descrita sem indicar o ritmo\footnote{Ou seja as mudanças na duração das notas musicais.},
