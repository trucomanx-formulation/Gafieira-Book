...
ou seja quias serão os tempos fortes, semifortes e fracos no compasso.
...
ou seja, está sobreintendida \cite[pp. 141,217]{medteoria}.
\end{tcbinformation} 
...
com maior \hyperref[sec:pos:Intensidade]{\textbf{intensidade}}; ou seja, com acentuação.
...
tendo eles uma formula de compasso 2/2; ou seja, 
...
ou seja tem um menor \hyperref[sec:pos:Intensidade]{\textbf{intensidade}} que a nota do primeiro tempo.
...
tendo eles uma formula de compasso 4/4; ou seja, 
...
esta contagem se incrementa ao inicio de cada compasso; ou seja no tempo 1 (tempo forte).
\begin{example}
