...
\index{Música!Pulso}
\label{ref:Pulso}
O pulso é uma occorrencia regular, porem não organizada por acentos;
...
porem é possivel fazer uma difereça.
Exemplo: Num compás 6/8 temos 6 pulsos porem só 2 tempos \cite[pp. 1228]{latham2008diccionario}.
\end{tcbinformation} 
