...
%% SECTION
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\section{\textcolor{green}{Historia das gafieiras}}\index{Historia das gafieiras}
...
%%
%% Estudar Samba de gafieira a historia da dança de salão brasileira, pag 71
%  sobre: a primeira gafieira datada no seculo XiX 
%% 
