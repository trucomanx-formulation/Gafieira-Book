...
para a venta de um livreto de partituras musicais chamado ``Duquinho'', %\footnote{Duque como garoto-propaganda.},
...
``Balao'', 
pipa, % proto piao
miudinho, %% similar a um miudinho de forro ou de milonga
jongo, %% similar a um passo de forro (arrocha)
puladinho e %% proto puladinho 
rosca %% proto puladinho redondo
...
\item[1923:] No novembro de 1923 a revista parisiense ``La Danse'' publica fotografias descrevendo %(Seguindo o prof. Lucien Piau)
alguns passos de samba: %% Supeito que este cara ja está inventando passos
...
\begin{comment}
% http://catalogue.bnf.fr/ark:/12148/cb32862901k
\item[1925:] O dia 9 de maio de 1925, no jornal ``Rouen Gazette'' 
se menciona que O ``Boston-Club'' organizou o sabado anterior
o primeiro campeonato de dança da Normandia,
da qual se comenta:
``Em quanto ao samba...! que é apenas o velho maxixe brasileiro, renomeada,
ele é muito menos elegante do que este e os casais que dançaram, 
com uma ou duas exceções,
pode muito bem dançar qualquer coisa, menos samba!''
\end{comment}
...
\begin{comment}
%% https://www.libraryofdance.org/manuals/
Paul Raymond. (1922). Théorie de la Véritable Samba. Paris: Smyth. [Enge] [Powers]

Couple Dances: Samba (p. 1)
* La Marche (p. 1)
* Le Pas Penché (p. 1)
* Les Toccata (p. 1)
* Les Dégagés à Terre (p. 1)
* Le Pas de Samba (p. 1)
* Le Pas de Samba Épaulée (p. 1)
\end{comment}
          
\begin{comment}
%% https://www.libraryofdance.org/manuals/
M. Neerman, M.elle Violette Berquin (dance), Emilia D. E. de Farias (music). (1923). La Vraie Samba (Dengo-Dengo). Paris: Editions Francis Salabert. [Enge]
Couple Dances: La Samba (♬) (p. 3)
* La Marche (p. 3)
* Les Pas Pivotés (p. 3)
* Pas de Samba en Avant (p. 3)
* Pas de Samba en Arrière en Tournant (p. 3)
* Pas Rassemblés (p. 3)
* Pas de Samba Marqué (p. 3)
* Les Pas Battus (p. 3)
\end{comment}

\begin{comment}
%% https://www.libraryofdance.org/manuals/
Ruth Eleanor Howard (ed.). (1939, April). The American Dancer. New York. [Enge] [Powers]
Couple Dances: The Samba (p. 23)
\end{comment}

\begin{comment}
%% https://www.libraryofdance.org/manuals/
Arthur Murray. (c. 1939). Arthur Murray's Dance Book [a.k.a. The Dance Book of Arthur Murray]. New York: Arthur Murray. [Enge] [Powers]
Note: This is different from both the 1938 and 1941 editions.
Couple Dances: Samba (p. 96)
* Basic Step (p. 96)
* Pendulum Step (p. 98) 
\end{comment}
...
\begin{comment}
%% https://www.libraryofdance.org/manuals/
Lawrence Grant. (c. 1940). How to Do the Newest Dance Steps and Variations (Reader Mail Edition). Toronto: Reader Mail, Ltd. [Enge] [Powers]
Couple Dances: Samba (p. 24)
* Basic Step (p. 24)
* Samba Turn Left (p. 24)
\end{comment}
...
no ano 2001 se considera que este é um modo de dança extinto \cite[pp. 143]{perna2002samba}. % ou quase extinto.
...
\item ``Na baixada do sapateiro'' interpretado por Raul de Barros no álbum ``Raul De Barros Toca Para Dançar'' (1956). %% tem breques
%\item ``Amigo velho'' interpretado por Raul de Barros  no álbum ``Ginga de gafieira''. %% tem breques
