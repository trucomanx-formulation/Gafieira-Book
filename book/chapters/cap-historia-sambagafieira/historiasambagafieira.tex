...
\item[1922-1923:] Entre os anos 1922 e 1923 a revista francesa ``Dansons!'' 
...
Entre os passos descritos estavam: ``La Marcha'', ``Balao'', pipa, miudinho, jongo, puladinho e rosca \cite[pp. 3]{Dansons:12} \cite[pp. 3]{Dansons:13} \cite[pp. 3]{Dansons:14} \cite[pp. 3]{Dansons:15} \cite[pp. 7]{Dansons:25}.
...
Paul Boucher e Paul Gaffet publicam uma nova edição do seu livro de dança:
``Toutes les Danses Pour Tous - Illustrées par la Photographie'',
...
\begin{figure}[h]
  \centering
    \includegraphics[width=0.975\textwidth]{chapters/cap-historia-sambagafieira/gafieira-crono.eps}
