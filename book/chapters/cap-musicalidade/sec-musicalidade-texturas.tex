%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\section{Dinâmicas ou texturas na dança }
...
\subsection{Áreas o elementos da dança}
\index{Rudolf Laban}
...
sendo estes ligados a estágios no desenvolvimento da criança em crescimento \cite[pp. 12]{paine2014complete}.

No  final da década dos anos 1960 e 1970, 
...
Seguindo esses modelos, é comum achar na literatura atual \cite[pp. 4]{carline2011lesson} \cite[pp. 12-13, 27]{paine2014complete},
um a análises  da dança usando quatro áreas-chave:
\begin{description}
\item[Consciência das ações ou consciência do corpo:] O que o corpo está fazendo? \\ %\cite[pp. 4, 5]{carline2011lesson} \cite[pp. 27]{paine2014complete}.
O tema da consciência corporal é abordado na Seção \ref{sec:BodyAwareness}.
\item[Consciência da dinâmica ou esforço:] Como o corpo está se movendo?\\
Os diferentes fatores que podemos ter nas \hyperref[subsec:fatordinamica]{\textbf{dinâmicas}} 
do movimento, como: peso, tempo, espaço e fluência; são tratados na Seção \ref{subsec:fatordinamica}.
\item[Consciência do espaço:] Para onde o corpo se está movendo?\\
Refere-se à forma em que o espaço é usado e todas as direções, lugares, caminhos, etc. Que podemos explorar \cite[pp. 4, 6]{carline2011lesson} \cite[pp. 27, 31]{paine2014complete}.
\item[Consciência das relações:] Com quem ou com que o corpo está se movendo?\\
Na dança podemos movimentar-nos relacionando-nos com outra pessoa, como na dança social a  dois,
ou em grupos, como em algumas danças folclóricas \cite[pp. 4, 9]{carline2011lesson} \cite[pp. 27, 32]{paine2014complete}.
\end{description}
...
\begin{figure}[!h]
  \centering
    \includegraphics[width=0.75\textwidth]{chapters/cap-musicalidade/dinamicas-elementos2.eps}
...
\caption{Uso do clímax na dinâmica de tensão e relaxação.}
...
criando tensão muscular nosso último movimento antes do clímax na música,
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%% \subsection{\textcolor{red}{Dinâmica - Velocidade: ``slow motion'' e velocidade aumentada }}
