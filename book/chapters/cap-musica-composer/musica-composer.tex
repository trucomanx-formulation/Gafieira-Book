...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\section{\textcolor{red}{Articulação}}\index{Música!Articulação}

%https://es.wikipedia.org/wiki/Articulaci%C3%B3n_(m%C3%BAsica)

\subsection{\textcolor{red}{Simbolos de Acentos}}\index{Música!Acentos}

Sobre acentos  \cite[pp. 9]{phillips2002sight}

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\section{\textcolor{red}{Motivos}}\index{Música!Motivos}\index{Música!Motif}
