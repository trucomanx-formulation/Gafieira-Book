...
\begin{table}[h]
  ...
  Cadência interrompida & ?$\neq$I & Acontece quando se finaliza em qualquer grau 
  diferente da \hyperref[sec:Tonica]{\textbf{tônica}},
...
M: 2/4 %meter - compasso
V:1 %name="Pauta com clave de fá"   sname="Pauta com clave de fá"
[V:1] | [C2 E2 G2] [F2 A2 C'2]| [E2 G2 B2] [G2 B2 D'2]| [E2 G2 B2] [F2 A2 C'2]| [E2 G2 B2] z2|
w: ~ ~ ~ ~ ~ IV III
\end{abc}
...
quando ao final de um período temos uma nota diferente da \hyperref[sec:Tonica]{\textbf{tônica}} 
...
a primeira frase com uma cadência interrompida (IV-II) e a segunda frase com uma cadência (V-I).
\end{example}
