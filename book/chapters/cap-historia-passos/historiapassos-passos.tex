...
%porém não tem se achado referencias sobre as caraterísticas do movimento no maxixe.
...
porém com os papeis intercambiadas no par, com respeito ao tempo anterior;
na outra metade do ciclo se repete o movimento, porém agora é a outra pessoa que terá o eixo do par.
...
Porém, a existência do pica-pau no fandango não indica uma relação de vinculo parental do movimento,
...
\begin{comment}
A Figura \ref{fig:elevador50} mostra um fotograma do filme na qual se observa como o seguidor é elevado.
\begin{figure}[h!]
  \centering
...
\begin{comment}
A Figura \ref{fig:cadeirinha1950} mostra um fotograma deste filme, na qual se observa a cadeirinha.
\begin{figure}[h!]
  \centering
...
porém a ação do movimento dos pés não é uma causa e sim um efeito,
...
A posição do facão, é uma posição na qual o par de dança está num abraçado colado e frente a frente, 
...
porém não a mais interessante. Iniciamos desde o passo, frente-trás também chamado básico, 
...
é promovido pelo condutor, e tem forma de ``S'', 
de modo que uma ligeira curva para a esquerda é realizada no tempo 1 e 1.5,
no tempo  2 chegamos ao ponto neutro (ou meio), na qual a curva se intersecta com uma linha reta. 
Para chegar a 3, 
que também está sobre a linha reta e no final de ambas curvas,
o condutor promove um movimento curvo para a sua direita.
...
%%                CICLICO     |SIMETRICO   |CONTRATEMPO   |DESLOCAMENTOS |TIEMPOS
\caracterpasso{\NoCheckedItem}{\NoCheckedItem}{\NoCheckedItem}{\CheckedItem}{3}
...
\index{Passo!Trança}
Este movimento é antigo, porém Jaime Arôxa trabalhou sobre ele entre os anos de 1987 a 1990,
...
\index{Passo a contratempo!Balanço}
\index{Passo simétrico!Balanço}
...
%%                CICLICO     |SIMETRICO   |CONTRATEMPO   |DESLOCAMENTOS |TIEMPOS
\caracterpasso{\CheckedItem}{\CheckedItem}{\MaybeCheckedItem}{\NoCheckedItem}{2}
...
corrigir alguma descorrelação entre a música e nossa dança.
...
posição de X\footnote{\label{ref:saidalateral}Em todo esse processo os peitos do condutor 
...
coloca coloca o peso do corpo na sua perna direita levando ela atrás do seu plano 
...
finalmente, para chegar ao tempo 2 o condutor movimenta sua perna direita adiante de sua perna esquerda,
enquanto que o seguidor movimenta sua perna esquerda atrás de sua direita para 
ambos chegar na posição de X\footref{ref:saidalateral}.
...
e com os joelhos flexionados, geralmente o movimento se executa realizando deslocamentos sobre uma linha reta, 
...
e no tempo 2 o condutor pisa com sua perna direita levando ela em linha reta (geralmente) para adiante do seu 
\hyperref[def:PlanoFrontal]{\textbf{plano frontal}}, 
