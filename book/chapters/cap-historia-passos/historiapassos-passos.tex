...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\PRLsep{Passos no samba de gafieira até 1949}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\subsection{Balão} 
...
a revista ``Dansons!'' (Paris) publicou guias de ensino para dançar o samba, %\footnote{Este samba evoluiu no samba internacional.}, 
...
\index{Passo progressivo!Puladinho}
\begin{comment} 
...
\index{Passo progressivo!Elevador}
...
\index{Passo progressivo!Picadinho}
...
\index{Passo progressivo!Caminhada a contratempo}
%%                CICLICO     |SIMETRICO   |CONTRATEMPO   |DESLOCAMENTOS |TIEMPOS
...
\index{Passo progressivo!Faquinha}
...
a revista ``La Danse'' (Paris) publicou uma guia para dançar o samba, %\footnote{Este samba evoluiu no samba internacional.}, 
a qual incluía um movimento chamado ``les balancés'' \cite[pp. 10-11]{LaDanse:38}.
A descrição do movimento é muito similar ao balanço atual (\AnoLivro), % Com tempero abolerado
incluindo a distribuição de tempos ``tum tum''.


O balanço atual (\AnoLivro), na sua forma mais básica, é um movimento cíclico que dura dois tempos;
