...
o que mostra a notoriedade que adquiriam esses eventos, o locais, nessas datas.
\end{itemize}
...
no dia 3 de março de 1919, como título ``Club dos carnavalescos do Andarahy'' e subtitulo ``1ra Critica - A Gafieira'',
...
Para ter uma ideia de se este preço é pouco o muito podemos compará-lo com o 
...
Paralelamente na historia, Júlio Simões, socio e administrador do ``'Elite club', afirma que o jornalista tinha a costume de entrar, 
...
isto propiciado pelo aumento do número de locais que se atribuíam este nome e 
a diversidade e cultura do seu público e os administradores.
