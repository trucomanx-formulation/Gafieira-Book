...
\chapter{\textcolor{green}{Historia da música do samba}}\index{Música do samba}
...
e foi sucesso no carnaval e gravado em disco em 1917, 
cantado por ``Bahiano'' acompanhado somente 
de violão e cavaquinho \cite[pp. 35]{diniz2006almanaque} \cite{musicapelotelefone} \cite[pp. 290]{dourado2004dicionario}.
...
esta foi a indicação do gênero ``samba'' no selo do disco junto ao registro na Biblioteca Nacional, no 27 de novembro de 1916, 
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\section{\textcolor{blue}{Que estilos de dança posso usar no samba (música)?}}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\subsection{\textcolor{blue}{Estilos dançados em pares}}
Entre os estilos que se dançam a dois, temos \cite[pp. 134]{perna2002samba}:
\begin{description}
\item[Samba de gafieira (dança):] É uma dança a dois, que pode ser dançada na maioria dos subgêneros do samba (música),
tendo exceções em: samba-enredo, samba reggae (música), samba rock (música), marcha e maxixe (música) \cite[pp. 134]{perna2002samba}, 
para mais detalhes ver Seção \ref{subsec:gafieiradancaestilos}.
...
Uma referencia a este estilo de dança pode ser achada no livro ``Manual de Danças Gaúchas'' (1955)
...
\end{citando}
Outra referencia interessante está no livro 
``Feitiço decente: Transformações do samba no Rio de Janeiro (1917-1933)'' (2001),
onde se pode intuir a procedência do nome samba liso, 
quando faz referencia a um comentário de João da Baiana \cite[pp. 111]{sandroni2001feitico}: 
\begin{citando}
...
\end{citando}
Pelo que no livro se comenta, que para o dançarino solista  escolher a seu sucessor este
tem dois modalidades, em ``samba liso'' (com umbigada) ou em ``samba duro'' 
(ou batucada, no qual a umbigada é substituída por uma pernada)\footnote{Esta referença 
é particularmente interessante, pois como veremos na Seção \ref{cap:sambagafieira},
nos primórdios do samba nas gafieiras, existiam 3 formas de esta ser dançada: samba-canção(dança),
\textbf{samba-batucada} e \textbf{samba-liso}.} \cite[pp. 111]{sandroni2001feitico}.
