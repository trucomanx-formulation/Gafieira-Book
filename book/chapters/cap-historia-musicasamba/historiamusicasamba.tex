...
\begin{example}[Músicas da bossa nova:]~
...
\begin{example}[Músicas do choro:] ~
...
\begin{example}[Músicas do marchinha:] ~
...
\begin{example}[Músicas do marcha-rancho:] ~
...
até que cedeu seu lugar ao samba \cite[pp. 4]{musicasambavariasdef1}.
...
\begin{example}[Músicas do maxixe:] ~
...
na qual as pessoas se reuniam, cantavam, dançavam, comiam e até paqueravam \cite[pp. 209]{diniz2006almanaque}.
...
\begin{example}[Músicas do sambalanço:] ~
...
\begin{example}[Músicas do sambalanço de 1990:] ~
...
\begin{example}[Músicas do samba-bolero:] ~
...
\begin{example}[Músicas do samba de breque:] ~
...
\begin{example}[Músicas do samba-choro:] ~
...
o samba-canção teve força até o aparecimento da bossa nova \cite[pp. 128]{perna2002samba}.
\begin{example}[Músicas do samba-canção:] ~
...
\begin{example}[Músicas do samba-enredo:] ~
...
\begin{example}[Músicas do samba de gafieira:] ~
...
\begin{example}[Músicas do samba de partido alto:] ~
...
\begin{example}[Músicas do samba exaltação:] ~
...
Funk como le gusta,
 etc.
\begin{example}[Músicas do samba rock:] ~
...
\begin{example}[Músicas do samba-funk:] ~
...
\begin{example}[Músicas do samba sincopado:] ~
...
%a industria da música no Brasil etiquetou esta música como ``axe music'' \cite[pp. 64]{crook2005brazilian},
...
\begin{example}[Músicas do samba reggae:] ~
