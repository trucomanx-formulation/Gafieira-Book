...
colframe=gray,
leftrule=12mm,%
overlay={\node[anchor=north west,outer sep=2pt] at (frame.north west) {\includegraphics[width=8mm]{Pictures/attention2.png}}; }}
...
\include{chapters/cap-intro/intro}
...
\include{chapters/cap-fundamentos/fundamentos}
...
%	PART
%----------------------------------------------------------------------------------------
\part{Partitura de movimiento}

\include{chapters/cap-partitura/partitura}
...
\include{chapters/cap-passos-basicos/passos-basicos}
